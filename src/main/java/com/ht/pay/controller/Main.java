...
import com.ht.pay.alipay.trade.config.Configs;
import com.ht.pay.alipay.trade.model.ExtendParams;
import com.ht.pay.alipay.trade.model.GoodsDetail;
import com.ht.pay.alipay.trade.model.builder.AlipayHeartbeatSynRequestBuilder;
import com.ht.pay.alipay.trade.model.builder.AlipayTradePayRequestBuilder;
import com.ht.pay.alipay.trade.model.builder.AlipayTradePrecreateRequestBuilder;
import com.ht.pay.alipay.trade.model.builder.AlipayTradeQueryRequestBuilder;
import com.ht.pay.alipay.trade.model.builder.AlipayTradeRefundRequestBuilder;
import com.ht.pay.alipay.trade.model.hb.EquipStatus;
import com.ht.pay.alipay.trade.model.hb.ExceptionInfo;
import com.ht.pay.alipay.trade.model.hb.HbStatus;
import com.ht.pay.alipay.trade.model.hb.PosTradeInfo;
import com.ht.pay.alipay.trade.model.hb.Product;
import com.ht.pay.alipay.trade.model.hb.SysTradeInfo;
import com.ht.pay.alipay.trade.model.hb.Type;
import com.ht.pay.alipay.trade.model.result.AlipayF2FPayResult;
import com.ht.pay.alipay.trade.model.result.AlipayF2FPrecreateResult;
import com.ht.pay.alipay.trade.model.result.AlipayF2FQueryResult;
import com.ht.pay.alipay.trade.model.result.AlipayF2FRefundResult;
import com.ht.pay.alipay.trade.service.AlipayMonitorService;
import com.ht.pay.alipay.trade.service.AlipayTradeService;
import com.ht.pay.alipay.trade.service.impl.AlipayMonitorServiceImpl;
import com.ht.pay.alipay.trade.service.impl.AlipayTradeServiceImpl;
import com.ht.pay.alipay.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.ht.pay.alipay.trade.utils.Utils;
import com.ht.pay.alipay.trade.utils.ZxingUtils;
...
//                .setNotifyUrl("http://www.test-notify-url.com")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("E:/qr-%s.png", response.getOutTradeNo());
